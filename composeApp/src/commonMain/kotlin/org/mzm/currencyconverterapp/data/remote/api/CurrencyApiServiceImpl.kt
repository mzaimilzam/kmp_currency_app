package org.mzm.currencyconverterapp.data.remote.api
...
import org.mzm.currencyconverterapp.domain.model.ApiResponse
import org.mzm.currencyconverterapp.domain.model.CurrencyCode
import org.mzm.currencyconverterapp.domain.model.toCurrency
...
class CurrencyApiServiceImpl(private val preferencesRepository: PreferencesRepository) : CurrencyApiService {
    ...
    override suspend fun getLastExchangesRates(): RequestState<List<Currency>> {
        return try {
